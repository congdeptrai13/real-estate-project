                ...
                <div class="agents-block-one">
                    <div class="inner-box mr-0">
                        <figure class="image-box"><img
                                ...
                                alt="" style="width: 270px; height:370px;">
                        </figure>
                                                ...
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="image"><img
                                                                src="{{ asset($item->property_thumnail) }}" alt=""
                                                    ...
                                                    <div class="lower-content">
                                                        <div class="title-text">
                                                            <h4><a
                                                                    href="property-details.html">{{ $item->property_name }}</a>
                                                            </h4>
                                                        </div>
                    ...
                    <div class="default-sidebar agent-sidebar">
                        <div class="agents-contact sidebar-widget">
                            ...
                            <div class="form-inner">
                                ...
                                @else
                                    <form action="{{ route('agent.send.message') }}" method="post" class="default-form">
                                        <input type="hidden" name="agent_id" value="{{ $agent->id }}">
                        ...
                        <div class="category-widget sidebar-widget">
                            ...
                            <ul class="category-list clearfix">
                                ...
                                <li><a href="{{ route("buy.property") }}">For Buy <span>({{ count($buyproperty) }})</span></a>
                                </li>
                            </ul>
                        </div>
                        <div class="featured-widget sidebar-widget">
                            ...
                            <div class="single-item-carousel owl-carousel owl-theme owl-nav-none dots-style-one">
                                @foreach ($featured_property as $feat)
                                    <div class="feature-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image"><img src="{{ asset($feat->property_thumnail) }}"
                                                        alt="">
                                                </figure>
                                                <div class="batch"><i class="icon-11"></i></div>
                                                <span class="category">Featured</span>
