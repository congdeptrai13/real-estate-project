                ...
                <div class="author-info clearfix">
                    @if ($property->agent_id == null)
                        <div class="author-box pull-left">
                            <figure class="author-thumb"><img src="{{ url('upload/admin_images/' . $admin->photo) }}"
                                    alt="">
                            </figure>
                            <h6>{{ $admin->name }}</h6>
                        </div>
                    ...
                    <div class="carousel-inner">
                        <div class="single-item-carousel owl-carousel owl-theme owl-dots-none">
                            @foreach ($multiImage as $img)
                                <figure class="image-box"><img src="{{ url(asset($img->photo_name)) }}" alt="">
                                </figure>
                            @endforeach
                    ...
                    <div class="author-widget sidebar-widget">
                        <div class="author-box">
                            @if ($item->agent_id == null)
                                <figure class="author-thumb"><img
                                        src="{{ url('upload/admin_images/' . $admin->photo) }}" alt="">
                                </figure>
                                <div class="inner">
                                    <h4>{{ $admin->name }}</h4>
                                    <ul class="info clearfix">
                                    ...
                                    @auth
                                        <div id="app">
                                            <send-message 
                                            :receiverid="{{ $property->agent_id }}"
                                            receivername="{{ $property->user->name }}"></send-message>
                                        </div>
                                    @else
                                ...
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        <div class="author pull-left">
                                            @if ($item->agent_id == null)
                                                <figure class="author-thumb"><img
                                                        src="{{ url('upload/admin_images/' . $admin->photo) }}"
                                                        alt="">
                                                </figure>
                                                <h6>{{ $admin->name }}</h6>
                                            @else
